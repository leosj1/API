...
echo ------------------------------------START------------------------------------------ >> Logs\Log_terms_%SUBFILENAME%.log
echo %date%-%time% >> Logs\Log_terms_%SUBFILENAME%.log
"C:\Users\seun\anaconda3\python.exe" "update_terms.py" >> Logs\Log_terms_%SUBFILENAME%.log 2>&1
echo %date%-%time% >> Logs\Log_terms_%SUBFILENAME%.log
echo ------------------------------------END------------------------------------------ >> Logs\Log_terms_%SUBFILENAME%.log
REM pause